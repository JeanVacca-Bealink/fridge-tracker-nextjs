...
export default function LoginPage() {
  const [state, loginFormAction, pending] = useActionState(login, initialState)
  const [signUpState, signUpFormAction, signup_pending] = useActionState(signup, initialState)
  return (
  <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <form  className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        ...
        <div>
          ...
          {signUpState?.message && <p aria-live="polite">{signUpState.message}</p>}
        </div>
        <div className="mb-4">
        ...
        <button
          ...
          disabled={pending || signup_pending}
